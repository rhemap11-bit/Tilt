...
# --- Set page config and pastel theme ---
st.set_page_config(page_title="Tilt", layout="centered")
st.set_option("theme.primaryColor", "#E8E1F8")  # pastel purple for sliders and highlights
...
# --- CSS for pastel backgrounds and fonts ---
st.markdown("""
<style>
...
severity = st.slider("Severity (1-10)", 1, 10, 5)  # now pastel purple
